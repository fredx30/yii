...
class CEmailValidator extends CValidator
{
	 ...
	 */
	public $pattern='/^[a-zåäöA-ZÅÄÖ0-9!#$%&\'*+\\/=?^_`{|}~-]+(?:\.[a-zåäöA-ZÅÄÖ0-9!#$%&\'*+\\/=?^_`{|}~-]+)*@(?:[a-zåäöA-ZÅÄÖ0-9](?:[a-zåäöA-ZÅÄÖ0-9-]*[a-zåäöA-ZÅÄÖ0-9])?\.)+[a-zåäöA-ZÅÄÖ0-9](?:[a-zåäöA-ZÅÄÖ0-9-]*[a-zåäöA-ZÅÄÖ0-9])?$/';
	/**
	 * @var string the regular expression used to validate email addresses with the name part.
	 * This property is used only when {@link allowName} is true.
	 * @see allowName
	 */
	public $fullPattern='/^[^@]*<[a-zåäöA-ZÅÄÖ0-9!#$%&\'*+\\/=?^_`{|}~-]+(?:\.[a-zåäöA-ZÅÄÖ0-9!#$%&\'*+\\/=?^_`{|}~-]+)*@(?:[a-zåäöA-ZÅÄÖ0-9](?:[a-zåäöA-ZÅÄÖ0-9-]*[a-zåäöA-ZÅÄÖ0-9])?\.)+[a-zåäöA-ZÅÄÖ0-9](?:[a-zåäöA-ZÅÄÖ0-9-]*[a-zåäöA-ZÅÄÖ0-9])?>$/';
	/**
